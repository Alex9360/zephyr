...
#error "Not valid"
	...
	(void)Cy_SysClk_PeriGroupSetSlaveCtl(1, CY_SYSCLK_PERI_GROUP_SL_CTL, 0xFFFFU);
	(void)Cy_SysClk_PeriGroupSetSlaveCtl(2, CY_SYSCLK_PERI_GROUP_SL_CTL, 0xFFFFU);
	...
	(void)Cy_SysClk_PeriGroupSetSlaveCtl(7, CY_SYSCLK_PERI_GROUP_SL_CTL, 0xFFFFU);
