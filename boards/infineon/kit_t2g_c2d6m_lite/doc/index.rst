...
.. zephyr-app-commands::
   :zephyr-app: samples/basic/blinky
   :board: kit_t2g_c2d6m_lite/cyt4dnjbzs/m0p
   :gen-args: -DCONFIG_INFINEON_CAT1C_START_M7_0=y -DCONFIG_INFINEON_CAT1C_START_M7_1=y
   :goals: build

The Cortex®-M7 cluster is exposed as a single board variant. By default, builds target
Cortex®-M7 Core 0:

.. zephyr-app-commands::
   :zephyr-app: samples/basic/blinky
   :board: kit_t2g_c2d6m_lite/cyt4dnjbzs/m7
   :goals: build

To target Cortex®-M7 Core 1, apply the ``t2g-c2d6m-cm7-core1`` snippet:

.. zephyr-app-commands::
   :zephyr-app: samples/basic/blinky
   :board: kit_t2g_c2d6m_lite/cyt4dnjbzs/m7
   :snippets: t2g-c2d6m-cm7-core1
   :goals: build
...
.. code-block:: shell
   ...
   west build -b kit_t2g_c2d6m_lite/cyt4dnjbzs/m0p -p always samples/basic/blinky
   west flash
   west debug
...
.. code-block:: shell
   ...
   west build -b kit_t2g_c2d6m_lite/cyt4dnjbzs/m0p -p always samples/basic/blinky \
       -- -DCONFIG_INFINEON_CAT1C_START_M7_0=y -DCONFIG_INFINEON_CAT1C_START_M7_1=y
   west flash
   west debug

Build and flash for the Cortex®-M7 Core 0 (default):

.. code-block:: shell

   west build -b kit_t2g_c2d6m_lite/cyt4dnjbzs/m7 -p always samples/basic/blinky
   west flash
   west debug

Build and flash for the Cortex®-M7 Core 1 (via snippet):

.. code-block:: shell

   west build -b kit_t2g_c2d6m_lite/cyt4dnjbzs/m7 -S t2g-c2d6m-cm7-core1 -p always samples/basic/blinky
   west flash
   west debug
