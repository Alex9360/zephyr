...
The path to the installed Infineon OpenOCD executable must be available to the ``west`` tool commands. The example below uses a permanent CMake argument to set the CMake variable ``OPENOCD``.
