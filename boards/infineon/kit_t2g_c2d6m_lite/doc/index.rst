...
- 2D and 2.5D graphics subsystem with 4096 KB embedded video RAM
- Programmable analog and digital peripherals that allow faster time-to-market

The TRAVEO™ T2G C-2D 6M Lite kit is equipped with a TRAVEO™ T2G Cluster family CYT4DN MCU in a
327-BGA package, expansion headers and headers that are compatible with Arduino shield.
Additionally, the board features an onboard programmer/debugger (KitProg3), a CAN FD transceiver,
an Ethernet PHY transceiver with RJ45 connector interface, a type-C connector for an USB device
interface, user LEDs, one potentiometer, and user push buttons. The board supports operating
voltages from 3.3 V to 5.0 V for the TRAVEO™ T2G CYT4DN MCU.
...
.. zephyr-app-commands::
   ...
   :board: kit_t2g_c2d6m_lite/cyt4dnjbds/m0p
   :goals: build
...
.. zephyr-app-commands::
   :zephyr-app: samples/basic/blinky
   :board: kit_t2g_c2d6m_lite/cyt4dnjbds/m7_0
   :goals: build
...
.. zephyr-app-commands::
   :zephyr-app: samples/basic/blinky
   :board: kit_t2g_c2d6m_lite/cyt4dnjbds/m7_1
   :goals: build
   ...
   .. tabs::
      .. group-tab:: Windows
         ...
         .. code-block:: shell
            ...
            west build -b kit_t2g_c2d6m_lite/cyt4dnjbds/m0p -p always samples/basic/blinky
