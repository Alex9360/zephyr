			     ...
			     const struct i2s_config *i2s_cfg)
{
	...
	case I2S_FMT_DATA_FORMAT_I2S:           align = CY_I2S_I2S_MODE; break;
	case I2S_FMT_DATA_FORMAT_LEFT_JUSTIFIED: align = CY_I2S_LEFT_JUSTIFIED; break;
	...
	if (dir == I2S_DIR_TX && blk_samp > TX_MAX_BLOCK_SAMPLES) return -EINVAL;
	if (dir == I2S_DIR_RX && blk_samp > RX_MAX_BLOCK_SAMPLES) return -EINVAL;
