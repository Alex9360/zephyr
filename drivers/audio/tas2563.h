...
#define TAS2563_AMP_LEVEL_MASK          0x3E  /* Bits [5:1] */
...
#define TAS2563_AMP_LEVEL_16_0DBV       0x10  /* Default */
...
#define TAS2563_SAMP_RATE_MASK          0x0E  /* Bits [3:1] */
...
#define TAS2563_RX_SCFG_MASK            0x30  /* Bits [5:4] */
...
#define TAS2563_RX_SLOT_LEFT_MASK       0x0F  /* Bits [3:0] */
#define TAS2563_RX_SLOT_RIGHT_MASK      0xF0  /* Bits [7:4] */
#define TAS2563_RX_SLOT_RIGHT_SHIFT     4

/* TDM_CFG4 (0x0A) */
#define TAS2563_TX_EDGE                 BIT(0)
#define TAS2563_TX_OFFSET_MASK          0x0E  /* Bits [3:1] */
...
#define TAS2563_BOOST_MODE_MASK         0xC0  /* Bits [7:6] */
...
/* MISC (0x32) */
#define TAS2563_IRQ_POL                 BIT(7)  /* 0=Active High, 1=Active Low */
...
#endif /* ZEPHYR_DRIVERS_AUDIO_TAS2563_REG_H_ */
