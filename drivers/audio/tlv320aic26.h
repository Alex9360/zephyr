...
#define AIC26_PAGE1                 1   /* Auxiliary / reset control    */
#define AIC26_PAGE2                 2   /* Audio control                */

#define AIC26_P1_REFERENCE          0x03  /* Reference control         */
#define AIC26_P1_RESET              0x04  /* Software reset trigger    */

/* Reference Control (Page 1, Reg 0x03) */
#define AIC26_VREFM_BIT             BIT(4)  /* 0=2.0V, 1=2.5V ref     */
#define AIC26_IREFV_BIT             BIT(0)  /* Internal ref voltage    */

/* Software Reset: write this value to trigger reset */
#define AIC26_RESET_VALUE           0xBB00

#define AIC26_P2_AUDIO_CTL1         0x00  /* Format, word length, Fs   */
#define AIC26_P2_DAC_GAIN           0x02  /* DAC volume & mute         */
#define AIC26_P2_POWER_CTL          0x05  /* Power management          */
#define AIC26_P2_AUDIO_CTL3         0x06  /* Master/slave, Fsref base  */
#define AIC26_P2_PLL1               0x1B  /* PLL config: P, J, Q       */
#define AIC26_P2_PLL2               0x1C  /* PLL config: D (fractional)*/
...
#define AIC26_DACFS_SHIFT           4     /* Bits [6:4] — NOT 3! */
...
/* DATFM field values */
#define AIC26_DATFM_I2S             0x00  /* I2S format                */
#define AIC26_DATFM_DSP             0x01  /* DSP/TDM format            */
#define AIC26_DATFM_RJ              0x02  /* Right-justified           */
#define AIC26_DATFM_LJ              0x03  /* Left-justified            */

/* DACFS field values (divisor applied to Fsref) */
#define AIC26_FS_DIV_1              0x00  /* Fs = Fsref / 1            */
#define AIC26_FS_DIV_1_5            0x01  /* Fs = Fsref / 1.5          */
#define AIC26_FS_DIV_2              0x02  /* Fs = Fsref / 2            */
#define AIC26_FS_DIV_3              0x03  /* Fs = Fsref / 3            */
#define AIC26_FS_DIV_4              0x04  /* Fs = Fsref / 4            */
#define AIC26_FS_DIV_5              0x05  /* Fs = Fsref / 5            */
#define AIC26_FS_DIV_5_5            0x06  /* Fs = Fsref / 5.5          */
#define AIC26_FS_DIV_6              0x07  /* Fs = Fsref / 6            */
...
/* DAC Gain: both channels muted + max attenuation */
